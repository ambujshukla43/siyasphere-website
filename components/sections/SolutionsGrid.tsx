...
const solutions = [
  ...
  },
  {
    ...
    title: "Account Intelligence & Prospect Research",
    value: "Know your buyers before you reach out.",
    outcomes: [
      "Profile and research target accounts with comprehensive firmographic data: industry verticals, company size, revenue, employee count, locations, and organizational structure",
      "Map technology landscapes and buying signals across your target market to identify accounts with specific pain points, incumbent vendors, or strategic initiatives",
      "Identify and verify decision-makers and influencers across multiple functions and departments with LinkedIn profiles, direct contact details, and role verification",
      "Enrich prospect records with verified email addresses, phone numbers, reporting relationships, and organizational hierarchy for accurate routing and personalization",
      "Build qualified opportunity lists with validated buyer intent signals, technology gaps, and scope alignment for faster sales qualification",
      "Enable targeted ABM campaigns with deep account insights, persona mapping, and multi-stakeholder engagement strategies",
    ],
  },
];
