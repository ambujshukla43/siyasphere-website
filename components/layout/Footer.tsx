          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex flex-col items-center space-y-2 text-sm">
              ...
              <a
                ...
                className="flex items-center gap-2 text-[#7FC6C4] hover:text-cyan-400 transition-colors"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
                ...
                <span className="font-semibold">siyasphere15@gmail.com</span>
              </a>
              ...
              <a
                ...
                className="flex items-center gap-2 text-[#0A66C2] hover:text-blue-400 transition-colors"
              >
                <svg
                  className="w-4 h-4"
                  fill="currentColor"
