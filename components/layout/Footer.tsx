        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {/* Contact Section */}
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg border border-[#7FC6C4]/20 p-3 hover:border-[#7FC6C4]/60 transition-all duration-300 hover:shadow-md hover:shadow-[#7FC6C4]/10">
                <div className="flex flex-col items-center space-y-2">
                  <div className="w-8 h-8 rounded-md bg-[#7FC6C4]/20 flex items-center justify-center">
                    <svg
                      className="w-4 h-4 text-[#7FC6C4]"
                      fill="none"
                      strokeLinecap="round"
                  ...
                  <a
                    ...
                    className="text-[#7FC6C4] hover:text-cyan-400 text-xs font-semibold transition-colors text-center break-all line-clamp-2"
                  >
